...
public class IntroLinePanel extends JPanel {
	...
	public IntroLinePanel(IntroducerSummary introSummary, final Integer rank, final PatientLinePanel panel,
		...
		introComboModel = controller.listAllIntroducer();
		combo = new JComboBox<Introducer>(introComboModel);
	...
	private JButton createRemoveLineButton(final Integer rank,
			final PatientLinePanel panel) {
		JButton removeLine = new JButton();
		removeLine.setIcon(new ImageIcon(getClass().getResource(
				"/icons/cross.png")));
